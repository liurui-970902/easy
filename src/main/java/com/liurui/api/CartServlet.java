...
import com.liurui.Dao.EasybuyUserAddressMapper;
import com.liurui.Dao.OrderDetailMapper;
import com.liurui.Dao.OrderMapper;
import com.liurui.Dao.ProductCategoryMapper;
import com.liurui.Service.CartService;
import com.liurui.Service.EasybuyOrderService;
import com.liurui.Service.EasybuyUserAddressService;
import com.liurui.Service.ProductCategoryService;
import com.liurui.Service.Impl.CartServiceImpl;
import com.liurui.Service.Impl.EasybuyOrderServiceImpl;
import com.liurui.Service.Impl.EasybuyUserAddressServiceImpl;
import com.liurui.Service.Impl.ProductCategoryServiceImpl;
import com.liurui.pojo.EasybuyCollect;
import com.liurui.pojo.EasybuyOrder;
...
import com.liurui.pojo.EasybuyUser;
import com.liurui.pojo.EasybuyUserAddress;
import com.liurui.utils.PrintUtil;
import com.liurui.utils.ReturnResult;
import com.liurui.utils.ShoppingCart;
import com.liurui.utils.ShoppingCartItem;
import com.liurui.utils.StringUtils;
...
public class CartServlet{
	...
	public void addNum(HttpServletRequest request, HttpServletResponse response) throws Exception{
		...
		ReturnResult result= new ReturnResult().returnFail("返回-1,从session中获取购物车");
		PrintUtil.write(result, response);
	}
	/**
	 * 购物车订单中 数量-1
