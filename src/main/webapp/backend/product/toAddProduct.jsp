<%@page import="com.liurui.pojo.EasybuyProductCategory"%>
<%@page import="com.liurui.pojo.EasybuyProduct"%>
	...
	<div class="i_bg bg_color">
		...
		<div class="m_content">
			...
			<div class="m_right" id="content" style="font-weight: bolder;">
				...
				<br>
				<form action="${ctx }/spring/ProductServlet/getImgs" method="post" id="productAdd" name="form1">
