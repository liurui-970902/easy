...
function pros(id,userId) {
	...
	if(userId != ""){
		location.href = contextPath+"/spring/ProductServlet/queryProductList?category="+id+"&userId="+userId;
	}else{
		location.href = contextPath+"/spring/ProductServlet/queryProductList?category="+id;
	}
