...
<div class="soubg">
	<div class="sou">
        ...
        <!-- 获取登陆用户昵称 -->
        <c:if test="${sessionScope.easybuyUserLogin!=null}">
            <span class="fl"><a href="${ctx }/spring/EasybuyUserServlet/index" style="color: red;font-weight: bolder;">${sessionScope.easybuyUserLogin.userName}</a>&nbsp;|&nbsp;<a href="${ctx }/spring/EasybuyOrderServlet/index?userId=${sessionScope.easybuyUserLogin.id}">我的订单</a>&nbsp;</span>
          </c:if>
          <!-- 管理员登陆显示 -->
          <c:if test="${sessionScope.easybuyUserLogin!=null && sessionScope.easybuyUserLogin.type==1}">
            <span class="fl">|&nbsp;<a href="${ctx }/spring/ProductServlet/index">后台管理</a>&nbsp;</span>
          </c:if>
          <!-- 登陆成功出现注销功能！没登录没有。。 -->
          <c:if test="${sessionScope.easybuyUserLogin!=null}">
             <span class="fl">|&nbsp;<a href="${ctx }/spring/EasybuyUserServlet/remove">注销</a>&nbsp;</span>
          </c:if>
        	...
        	<span class="ss">
            	<div class="ss_list">
                    ...
                    <div class="ss_list_bg">
                        ...
                        <div class="ss_list_c">
                        	<ul>
                            	<li><a href="${ctx}/spring/ProductServlet/queryProductList4?userId=${sessionScope.easybuyUserLogin.id}">收藏的宝贝</a></li>
                            </ul>
                        </div>
                    </div>     
                </div>
